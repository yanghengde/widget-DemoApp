(function () {
    'use strict';
    angular.module('Siemens.Mom.Presales.Training.DemoApp.Team')
        .constant('Siemens.Mom.Presales.Training.DemoApp.Team.TeamScreen.constants', ScreenServiceConstants())
        .service('Siemens.Mom.Presales.Training.DemoApp.Team.TeamScreen.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                ...
                entityName: 'Team',
                createPublicName: 'CreateTeam',
                updatePublicName: 'UpdateTeam',
                deletePublicName: 'DeleteTeam'
            }
        };
    }

    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.Mom.Presales.Training.DemoApp.Team.TeamScreen.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.Mom.Presales.Training.DemoApp.Team.TeamScreen.service');
        ...
        function createEntity(data) {
            ...
            var obj = {
                'Team':{'Name':data.Name,'Description':data.Description,'Number':data.Number },'IsActive':data.IsActive,'IsLeader':data.IsLeader
            };
        ...
        function updateEntity(data) {
            // TODO: Customize the mapping between "UI entity" and the "DB entity" that will create
            var obj = {
                'Id': data.Id,'Team':{'Name':data.Name,'Description':data.Description,'Number':data.Number },'IsActive':data.IsActive,'IsLeader':data.IsLeader
            };
    ...
    ScreenServiceRun.$inject = ['Siemens.Mom.Presales.Training.DemoApp.Team.TeamScreen.constants', 'common.base'];
